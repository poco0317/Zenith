...
local f =
	...
	Texture="_msd fg",
	InitCommand = function(self)
		self:xy(frameX - 30, frameY - 87):zoomto(frameWidth + 15, frameHeight + 35):halign(0):valign(0)
	end,
	},
	Def.Sprite {
	Texture="_msd bgmask",
	InitCommand = function(self)
		self:xy(frameX - 30, frameY - 87):zoomto(frameWidth + 15, frameHeight + 35):halign(0):valign(0):diffusealpha(0.8)
	end,
	},
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(5, offsetY - 5):zoom(0.9):halign(0):diffuse(getMainColor("positive")):settext("Filters")
			end
		},
	...
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(frameX, frameY):zoom(textzoom + .3):halign(0)
			end,
			SetCommand = function(self)
	...
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(frameX, frameY + 20):zoom(textzoom + .3):halign(0)
			end,
			SetCommand = function(self)
	...
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(frameX, frameY + 40):zoom(textzoom + .3):halign(0)
			end,
			SetCommand = function(self)
	...
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(frameX, frameY + 60):zoom(textzoom + .3):halign(0)
			end,
			SetCommand = function(self)
	...
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(frameX, frameY + 80):zoom(textzoom + .3):halign(0)
			end,
			SetCommand = function(self)
	...
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(frameX + frameWidth / 2, 175):zoom(textzoom + .3):halign(0)
			end,
			SetCommand = function(self)
	...
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(frameX + frameWidth / 2, 175 + spacingY):zoom(textzoom + .3):halign(0)
			end,
			SetCommand = function(self)
	...
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(frameX + frameWidth / 2, 175 + spacingY * 2):zoom(textzoom + .3):halign(0)
			end,
			SetCommand = function(self)
	...
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(frameX + frameWidth / 2, 175 + spacingY * 3):zoom(textzoom + .3):halign(0)
			end,
			SetCommand = function(self)
	...
	LoadFont("ZenithBold") ..
		{
			InitCommand = function(self)
				self:xy(frameX + frameWidth / 2, 175 + spacingY * 4):zoom(textzoom + 0.2):halign(0):settext("")
			end,
...
f[#f + 1] =
	...
	{
		InitCommand = function(self)
			self:xy(frameX + frameWidth - 150, frameY + 250):halign(0.5):zoom(textzoom + .4)
		end,
