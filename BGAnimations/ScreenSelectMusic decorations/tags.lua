...
t[#t + 1] =
	...
	InitCommand = function(self)
		self:xy(frameX, frameY):zoomto(frameWidth, frameHeight):halign(0):valign(0)
	end
}
t[#t + 1] =
	Def.Sprite {
	Texture="_msd bgmask",
	InitCommand = function(self)
		self:xy(frameX, frameY):zoomto(frameWidth, frameHeight):halign(0):valign(0):diffusealpha(0.8)
	end
}
t[#t + 1] =
