...
function LoadCard(cColor)
	local t =
		...
		Def.Quad {
			...
			OnCommand = function(self)
				self:diffusealpha(0.5):diffuse(Color.Red)
			end
		}
	}
	return t
...
t[#t + 1] =
	...
	{
		InitCommand = function(self)
			self:xy(5, 32):halign(0):valign(1):zoom(0.55):diffuse(Color.Scroll):settext("Select Profile:")
		end
	}
